...
const SEO = ({
  ...
  canonicalUrl = 'https://keetchelevator.in',
  ogType = 'website',
  ogImage = 'https://keetchelevator.in/Logo.png',
  structuredData = null,
  noIndex = false,
}) => {
...
export const seoData = {
  ...
  services: {
    ...
    canonicalUrl: 'https://keetchelevator.in/services',
    structuredData: {
  ...
  projects: {
    ...
    canonicalUrl: 'https://keetchelevator.in/projects',
  },
  about: {
    ...
    canonicalUrl: 'https://keetchelevator.in/about',
  },
  contact: {
    ...
    canonicalUrl: 'https://keetchelevator.in/contact',
  },
  quote: {
    ...
    canonicalUrl: 'https://keetchelevator.in/quote',
  },
};
