...
const SEO = ({
  ...
  canonicalUrl = 'https://keetechelevator.in',
  ogType = 'website',
  ogImage = 'https://keetechelevator.in/Logo.png',
  structuredData = null,
  noIndex = false,
}) => {
...
export const seoData = {
  ...
  services: {
    ...
    canonicalUrl: 'https://keetechelevator.in/services',
    structuredData: {
  ...
  projects: {
    ...
    canonicalUrl: 'https://keetechelevator.in/projects',
  },
  about: {
    ...
    canonicalUrl: 'https://keetechelevator.in/about',
  },
  contact: {
    ...
    canonicalUrl: 'https://keetechelevator.in/contact',
  },
  quote: {
    ...
    canonicalUrl: 'https://keetechelevator.in/quote',
  },
};
